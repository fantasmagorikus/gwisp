param(
    [string]$InstallDir = "$env:LOCALAPPDATA\Gwisp\SyncOCR",
...
$LauncherPath = Join-Path $InstallDir "Run-Gwisp-SyncOCR.bat"
@"
@echo off
cd /d "%~dp0"
".venv\Scripts\python.exe" run_gwisp_sync_ocr.py
pause
...
Write-Host ""
Write-Host "Gwisp Sync OCR installed successfully."
Write-Host "Install folder: $InstallDir"
Write-Host "Launcher: $LauncherPath"
Write-Host ""
Write-Host "Run it on the secondary machine, click Sync OCR, and copy Host/Port/Token into the main app."
